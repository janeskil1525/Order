package WebShop::Helper::Mail::User::PoCreated;
...
sub createAndSendMail{
    ...
    my $order_head = $self->_get_order_head($data->{purchaseorder_head_pkey});
    ...
    $templatedata->{mailtemplate} = 'pocreated';
